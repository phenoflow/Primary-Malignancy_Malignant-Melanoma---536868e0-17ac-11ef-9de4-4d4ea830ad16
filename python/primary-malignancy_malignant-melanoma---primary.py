...
codes = [{"code":"BBEN.11","system":"readv2"},{"code":"BBE1.13","system":"readv2"},{"code":"BBE4.00","system":"readv2"},{"code":"7G03J00","system":"readv2"},{"code":"BBE2.00","system":"readv2"},{"code":"BBEH.00","system":"readv2"},{"code":"BBEP.00","system":"readv2"},{"code":"4M3..00","system":"readv2"}];
REQUIRED_CODES = 1;
