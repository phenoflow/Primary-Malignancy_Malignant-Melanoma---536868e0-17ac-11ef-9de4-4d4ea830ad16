...
steps:
  ...
  external-primary-malignancy_malignant-melanoma---primary:
    run: external-primary-malignancy_malignant-melanoma---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  canal-primary-malignancy_malignant-melanoma---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: external-primary-malignancy_malignant-melanoma---primary/output
